...
| `per_topic_throughput` | `sum by (topic)(rate(kafka_server_brokertopicmetrics_messagesin_total[5m]))` | 4 series: `orders` 49.2/s, `payments` 9.85/s, `__consumer_offsets` 6.0/s, `{}` 65.1/s (the broker-wide series) |
